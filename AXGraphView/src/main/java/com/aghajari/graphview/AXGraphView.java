...
public class AXGraphView extends View {
    ...
    protected float[] paintsStrokeWidth = new float[4];
    ...
    public Matrix createDefaultMatrix() {
        ...
        if (options != null && options.axis!=null && options.axis.x!=DEFAULT) axisX += options.axis.x;
        if (options != null && options.axis!=null && options.axis.y!=DEFAULT) axisY += options.axis.y;
